...
plt.title("Random Forest (Data 01)")
plt.suptitle('Error ((actual-predicted)^2/actual) % : '+str(error1))
plt.savefig('graph/oilngas01_random_forest.png')
plt.show()
...
ax1.set_title("Feature Importance (Data 01) Random Forest")
ax1.figure.savefig('graph/oilngas01_random_forest_feature_importnace.png')
