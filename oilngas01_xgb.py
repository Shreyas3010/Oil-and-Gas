...
regressor =  xgboost.XGBRegressor(n_estimators=100,max_depth=5)
...
plt.title("XGB (Data 01)")
plt.suptitle('Error ((actual-predicted)^2/actual) % : '+str(error1))
plt.savefig('graph/oilngas01_xgb.png')
plt.show()
...
ax1.set_title("Feature Importance (Data 01) XGB")
ax1.figure.savefig('graph/oilngas01_xgb_importnace.png')
